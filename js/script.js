const projects = [
  {
    ...
    githubURL: 'https://github.com/dfizzkruah93/dfizzkruah93.github.io/Pofolio-Project/',
    websiteURL: 'https://dfizzkruah93.github.io/Pofolio-Project/',
  },
...
document.querySelector('#contact-form').addEventListener('submit', (e) => {
  ...
  if (valid) {
    ...
    e.preventDefault();
    responseContainer.innerHTML = 'Please enter your email in lower case only';
  }
});
